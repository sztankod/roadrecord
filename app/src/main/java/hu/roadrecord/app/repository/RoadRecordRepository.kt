...
class RoadRecordRepository(private val dao:RoadRecordDao){
 ...
 suspend fun seedDemo(){if(dao.dayCount()>0)return;ensureDefaults();val period=dao.activePeriod()!!;val placeIds=listOf(

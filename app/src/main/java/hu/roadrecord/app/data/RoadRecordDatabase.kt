...
@Database(entities=[WorkPeriod::class,WorkDay::class,WorkEvent::class,Trip::class,GpsPoint::class,LocationPlace::class,DailyPlacePlan::class,PlaceVisit::class,AppSettings::class],version=3,exportSchema=true)
...
abstract class RoadRecordDatabase:RoomDatabase(){
 ...
 companion object { @Volatile private var instance:RoadRecordDatabase?=null
  ...
  fun get(context:Context)=instance?:synchronized(this){instance?:Room.databaseBuilder(context.applicationContext,RoadRecordDatabase::class.java,"roadrecord.db").addMigrations(MIGRATION_1_2,MIGRATION_2_3).build().also{instance=it}}
 }
}

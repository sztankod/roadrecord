...
data class AppSettings(@PrimaryKey val id:Int=1,val hourlyRate:Long=4500,val includeTravelInEarnings:Boolean=true,val automaticPlaceRecognition:Boolean=false,val reportEmail:String="",val reportFrequency:String="PERIOD_CLOSE",val automaticReports:Boolean=false,val showWorkTime:Boolean=true,val showTravelTime:Boolean=true,val showEarnings:Boolean=true,val dataResetVersion:Int=1,val overnightRepairVersion:Int=1,val automaticBakeryTrips:Boolean=false,val currentPlaceId:Long?=null)
